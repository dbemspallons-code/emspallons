...
export default function StudentForm({
  ...
  const validate = () => {
    ...
    if (!hasClasses) {
      nextErrors.classGroup = 'Aucune classe disponible. Ajoutez une classe dans Paramètres.';
    ...
    <form className="card layout-grid fade-in scroll-reveal" style={{ padding: '1.5rem' }} onSubmit={handleSubmit}>
      ...
      <div className="layout-grid layout-grid--balanced">
        ...
        <Field label="Classe/Groupe" error={errors.classGroup}>
          ...
          >
            <option value="">
              {loadingData 'Chargement...' : hasClasses ? 'Sélectionner une classe' : 'Aucune classe disponible'}
            </option>
            {classes.map(classe => (
