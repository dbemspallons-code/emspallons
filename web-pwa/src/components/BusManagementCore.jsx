  ...
  const helpTopics = useMemo(() => ([
...

    {
      ...
      steps: [
        ...
        'Confirmez la priode rgler puis validez : le paiement est enregistr.',
  ...
  const handleSaveSettings = async ({ defaultMonthlyFee: nextDefaultFee, alertThreshold: nextAlertThreshold, vacationMessage: nextVacationMessage, pausedMonths: nextPausedMonths }) => {
    ...
    try {
      ...
      setMessageStatus(addedPaused.length || removedPaused.length
        ...
        ? 'Paramtres enregistrs. Mois en pause mis jour.' : 'Paramtres enregistrs.'
      ...
      await educatorLog({
        ...
        description: 'Mise jour des paramtres',
      ...
      setMessageStatus(`Erreur lors de l'enregistrement des paramtres : ${err.message}`);
