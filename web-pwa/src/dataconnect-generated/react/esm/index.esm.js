import { addMovieToListRef, getPublicListsRef, createUserReviewRef, getMoviesByGenreRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useCreateUserReview(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
