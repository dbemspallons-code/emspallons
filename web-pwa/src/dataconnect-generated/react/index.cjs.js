const { addMovieToListRef, getPublicListsRef, createUserReviewRef, getMoviesByGenreRef, connectorConfig } = require('../index.cjs.js');
...
exports.useCreateUserReview = function useCreateUserReview(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
    return createUserReviewRef(dcInstance, vars);
  }
  return useDataConnectMutation(refFactory, inputOpts, CallerSdkTypeEnum.GeneratedReact);
}
